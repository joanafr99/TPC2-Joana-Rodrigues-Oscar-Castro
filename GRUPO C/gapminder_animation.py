...
"""
Para construit o GIF (animado) usar o programa Image Magick - https://imagemagick.org/

# Then use image magick (this is bash, not python) - LINHA DE COMANDO, TERMINAL

c:\magick convert -delay 80 Gapminder*.png animated_gapminder.gif
